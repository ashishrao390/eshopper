...
<form method="POST" action="{{url('/')}}/admin">
  <div class="mb-3">
    ...
    @error('selectemail')<x-message-component msg={{$message}} cls="danger"/>@enderror
  </div>
  @csrf
  <div class="mb-3">
      <div class="row g-2">
      ...
      <div class="row g-2">
        <div class="col-md">
          <div class="form-floating">
            ...
            <input type="email" class="form-control" id="gender" disabled>
          </div>
        </div>
        <div class="col-md">
          <div class="form-floating">
            <label for="floatingInputGrid">Age</label>
            <input type="email" class="form-control" id="age" disabled>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row g-2">
        <div class="col-md">
          <div class="form-floating">
            ...
            <textarea id="address" rows="7" cols="50" type="textarea" class="form-control" disabled></textarea>
          </div>
        </div>
        <div class="col-md">
          <div class="form-floating">
            <label for="floatingInputGrid">State</label>
            <input type="email" class="form-control" id="state" disabled>
          </div>
        </div>
      </div>
    </div>
