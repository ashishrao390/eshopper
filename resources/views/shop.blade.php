...
<!-- Page Header Start -->
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">@if(!empty($weartypename) && $weartypename != ''){{$weartypename}} @else Our Shop @endif</h1>
            ...
            <div class="col-lg-3 col-md-12">
                ...
                <div class="mb-5">
                    ...
                    <form>
                        ...
                        <div class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="{{$size['id']}}">
                            <label class="custom-control-label" for="{{$size['id']}}">{{$size['size_label']}}</label>
                            <span class="badge border font-weight-normal">150</span>
                        </div>                            
                        @endforeach
                    </form>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                            <div class="card product-item border-0 mb-4">
                                <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                    <img class="img-fluid w-100" src="{{url('img/'.$product->image_url)}}" alt="">
                                </div>
